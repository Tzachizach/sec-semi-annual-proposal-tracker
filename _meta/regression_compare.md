...
| Accountant CPA | +1.52 | 0.182 | +0.057 | 0.446 | +1.63 | 0.022 |
| Issuer-current | +2.01 | 0.110 | +0.167 | 0.376 | +2.34 | 0.000 |
| Issuer-former | (sep.) | 0.941 | -0.022 | 0.017 | +1.78 | 0.039 |
| Investment prof. | (sep.) | 0.985 | -0.026 | 0.030 | (sep.) | 0.971 |
| Academic | +1.42 | 0.391 | +0.273 | 0.294 | +1.97 | 0.025 |
| Industry pract. | (sep.) | 0.989 | -0.030 | 0.035 | -0.66 | 0.565 |
| Student | +2.99 | 0.027 | +0.304 | 0.284 | +2.17 | 0.123 |
| log(words+1) | +0.71 | 0.026 | +0.015 | 0.068 | +0.75 | 0.000 |
...
| Ordinal logit | 454 | -110.56 | 0.234 |
...
- Ordinal logit LL: -110.56
- Multinomial logit LL: -104.79
- LR = 2 × (-104.79 − -110.56) = 11.55, df = 8, p = 0.1727

Under H0 (proportional odds holds), LR follows χ²(8). p = 0.1727 → do not reject proportional-odds. Note: small-N artifact warning — the LR test has low power with the current Support count.
