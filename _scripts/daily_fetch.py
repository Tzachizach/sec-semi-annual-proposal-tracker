...
def main():
    ...
    for r in new_rows:
        ...
        # Prefer the index name (cleaner), fall back to letter header
        ...
        rec = {
            ...
            "rationales_majority": [],
            "rationale_agreement": "",
            "summary": "(Awaiting Claude classification.)",
            "url": r["url"],
            "words": words,
            "letter_id": lid(r["url"]),
        }
        ...
        # Letters/NN_*.md placeholder file
        slug = fname_safe(commenter)
        fpath = LETTERS_DIR / f"{rec['n']}_{slug}_{rec['letter_id']}.md"
        header = (
